...
<div class="mb-3">
    ...
    <input type="text" placeholder="English Name" name="name_en" class="form-control" value="{{ $category->name }}" />
</div>
<div class="mb-3">
    <label>Arabic Name</label>
    <input type="text" placeholder="Arabic Name" name="name_ar" class="form-control" value="{{ $category->name }}"/>
</div>
<div class= "mb-3">
